...
class PartnerRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'time_open' => 'required|date_format:H',
            'time_close' => 'required|date_format:H',
    ...
    public function messages()
    {
        $message = [
            ...
            'time_open.date_format' => 'Giờ không đúng định dạng',
            'time_close.required' => 'Vui lòng nhập giờ mở cửa nhà hàng',
            'time_close.date_format' => 'Giờ không đúng định dạng',
