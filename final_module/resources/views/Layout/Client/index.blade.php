  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="{{ route('client.listFood') }}" class="nav-link">Trang chủ</a>
      </li>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{route('client.listFood')}}" class="nav-link">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{route('client.createFood')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
          ...
          @endif
            @if (Session::get('user_restaurant') != 0)
                <li class="nav-item">
                    <a href="{{route('client.partner.edit', Session::get('user_restaurant'))}}" class="nav-link">
                        <i class="nav-icon fas fa-home"></i>
                        <p>
                            {{ __('Sửa thông tin')}}
